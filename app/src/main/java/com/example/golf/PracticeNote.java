...
public class PracticeNote extends AppCompatActivity {
    ...
    String imagename, score, userid,  add_advice1, add_advice2, add_advice3, taway_advice, top_advice1, top_advice2, top_advice3, down_advice, imp_advice1,
            imp_advice2, imp_advice3 , thu_advice1, thu_advice2, thu_advice3, thu_advice4, thu_advice5,top_advice4, top_advice5, down_advice2 ,worst, adressscore, takebackscore, topascore,
    ...
    protected void writefile(String num) {
        try{
            ...
            writer6.newLine();
            writer6.write(thu_advice4);
            writer6.newLine();
            writer6.write(thu_advice5);
            writer6.newLine();
            ...
            writer7.write(finish_advice1);
            writer7.newLine();
            writer7.write(finish_advice2);
            writer7.newLine();
            writer7.write(finish_advice3);
            writer7.newLine();
    ...
    protected void readfile(String num) {
        try {
            ...
            thu_advice4=buf6.readLine();
            thu_advice5=buf6.readLine();
            ...
            finish_advice1=buf7.readLine();
            finish_advice2=buf7.readLine();
            finish_advice3=buf7.readLine();
